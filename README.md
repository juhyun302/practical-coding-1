...
<p>
  실전코딩1에서 수행한 여러 실습을 단순히 나열하지 않고,<br>
...
- 아주대학교 실전코딩1 수업에서 작성한 개인 학습 결과물입니다.
- 담당 교수님의 공개 허용을 확인한 뒤 포트폴리오 목적으로 정리했습니다.
- 수업 당시의 학습 흐름을 유지하면서 개인정보, 비밀 키, 로컬 비밀번호와 불필요한 빌드 결과물은 제거했습니다.
